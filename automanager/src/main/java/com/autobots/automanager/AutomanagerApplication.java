...
public class AutomanagerApplication {
	...
	public static class Runner implements ApplicationRunner {
		...
		public void run(ApplicationArguments args) throws Exception {
			...
			cliente = new Cliente();
			//
			cliente.setNome("Peter Cullen");
			cliente.setDataCadastro(Calendar.getInstance().getTime());
			cliente.setDataNascimento(calendario.getTime());
			cliente.setNomeSocial("Peter Cullen");
			
			telefone = new Telefone();
			//
			telefone.setDdd("1");
			telefone.setNumero("19410728");
			cliente.getTelefones().add(telefone);
			
			endereco = new Endereco();
			//
			endereco.setEstado("Quebec");
			endereco.setCidade("Montreal");
			endereco.setBairro("Arrival");
			endereco.setRua("7th Street, 21st Ave");
			endereco.setNumero("2032");
			endereco.setCodigoPostal("2007");
			endereco.setInformacoesAdicionais("ZHyaVvekWek");
			cliente.setEndereco(endereco);
